...
Rem
bbdoc: Composes a custom blend mode for renderers.
returns: An SDL_BlendMode that represents the chosen factors and operations.
param: srcColorFactor The #ESDLBlendFactor applied to the red, green, and blue components of the source pixels.
param: dstColorFactor The #ESDLBlendFactor applied to the red, green, and blue components of the destination pixels.
param: colorOperation The #ESDLBlendOperation used to combine the red, green, and blue components of the source and destination pixels.
param: srcAlphaFactor The #ESDLBlendFactor applied to the alpha component of the source pixels.
param: dstAlphaFactor The #ESDLBlendFactor applied to the alpha component of the destination pixels.
param: alphaOperation The #ESDLBlendOperation used to combine the alpha component of the source and destination pixels.
about:
	...
	pass it to either render #SetDrawBlendMode or texture #SetBlendMode. They will return with an error if the blend mode is not supported.
